<%@page import="fr.epita.quiz.datamodel.MCQ_Questions"%>
<%@page import="fr.epita.quiz.services.Generic_DAO"%>
...
<html>
<%
	List<MCQ_Questions> questionsList = (List<MCQ_Questions>)session.getAttribute("questionsList");
				...
				<table class="table">
					...
					<tbody>
					   ...
					   <%
						   					   				   					   				   					   			   ...
						   					   				   					   				   					   			   for (MCQ_Questions id : questionsList){
						   					   %>
						<tr>
